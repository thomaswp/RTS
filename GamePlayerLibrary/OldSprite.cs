...
namespace Game_Player
{
    ...
    /// </summary>
    public class OldSprite : IComparable
    {
        ...
        public OldSprite(Viewport viewport)
        {
        ...
        public OldSprite(Viewport viewport, Bitmap bitmap)
        {
            this.viewport = viewport;
            id = Viewport.AddSprite(this);
            Bitmap = bitmap;
        ...
        public OldSprite(Viewport viewport, int x, int y, int width, int height)
        {
            this.viewport = viewport;
            id = Viewport.AddSprite(this);
        ...
        public OldSprite(Viewport viewport, Rect rect)
        {
            this.viewport = viewport;
            id = Viewport.AddSprite(this);
